...
<body>
    ...
    <section class="container-fluid rwanda-at-glance-hero">
        ...
        <div class="container">
            ...
            <p class="rwanda-at-glance-hero-desc">Discover a nation of rapid progress, strong leadership, vibrant culture, and<br> opportunity—where innovation, safety, and sustainability shape the future.</p>
        </div>
    </section>
    ...
    <section class="container-fluid rwanda-at-glance-facts">
        <div class="container">
            <div class="rwanda-at-glance-facts-content d-flex justify-content-between align-items-center">
                ...
                <p class="rwanda-at-glance-facts-text">Get a quick view of Rwanda’s standout indicators—showcasing why it’s a country built on progress and ready for investment.</p>
            </div>
                ...
                <div class="col-md-3">
                    <div class="px-2">
                        <div class="rwanda-at-glance-lang">
                            ...
                            <span class="rwanda-glance-lang-desc">Still spoken, especially among older generations</span>
                        </div>
                    </div>
    ...
    <section class="container-fluid rwanda-at-glance-unique">
        <div class="container">
            <div class="rwanda-at-glance-unique-content d-flex justify-content-between align-items-center">
                ...
                <p class="rwanda-at-glance-unique-text">Rwanda is more than numbers—it’s a story of resilience, smart governance, and a forward-thinking vision.</p>
            </div>
                ...
                <div class="col-md-4">
                    <div class="px-2">
                        ...
                        <div class="rwanda-at-glance-blog-content">
                            ...
                            <span class="rwanda-at-glance-blog-excerpt">Transparent institutions, zero tolerance for corruption, and efficient government services drive long-term stability and trust.</span>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="px-2">
                        ...
                        <div class="rwanda-at-glance-blog-content">
                            ...
                            <span class="rwanda-at-glance-blog-excerpt">From banning plastic bags to building green cities, Rwanda is leading Africa in climate-conscious development.</span>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="px-2">
                        ...
                        <div class="rwanda-at-glance-blog-content">
                            ...
                            <span class="rwanda-at-glance-blog-excerpt">Post-conflict transformation has created a society focused on inclusion, innovation, and collective advancement.</span>
                        </div>
                    </div>
            ...
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="px-2">
                        ...
                        <h2 class="rwanda-at-glance-workforce-subheading">A Young, Educated,<br>Multilingual Workforce</h2>
                        <p class="rwanda-at-glance-workforce-desc">Rwanda’s young, educated population offers long-term labor force strength and inclusive leadership in both public and private sectors.</p>
    ...
    <section class="container-fluid rwanda-at-glance-flag d-flex align-items-center">
        <div class="container">
                <div class="rwanda-at-glance-flag-content d-flex flex-column align-items-end">
                    <h4 class="rwanda-at-glance-flag-quote">“Rwanda’s story is one of resilience, innovation,<br> and ambition. We are building a future with<br> everyone at the table”</h4>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7 d-flex flex-column justify-content-center">
                    <div class="pe-2 ps-5">
                         ...
                         <p class="rwanda-at-glance-map-text mt-4">Located in the heart of Africa’s Great Lakes region, Rwanda connects you to over 400 million people via the East African Community and African Continental Free Trade Area (AfCFTA).</p>
